...
export function mockPlayerComparisonResponse(payload: {
  ...
  const player1Name = 'Jogador A'
  const player2Name = 'Jogador B'

  const player1Snapshots = [
    { matchweek: 1, points: 21, position: 6 },
    { matchweek: 2, points: 38, position: 4 },
    { matchweek: 3, points: 57, position: 3 },
    { matchweek: 4, points: 74, position: 2 },
    { matchweek: 5, points: 91, position: 2 },
    { matchweek: 6, points: 108, position: 1 },
  ]

  const player2Snapshots = [
    { matchweek: 1, points: 18, position: 9 },
    { matchweek: 2, points: 33, position: 7 },
    { matchweek: 3, points: 48, position: 6 },
    { matchweek: 4, points: 64, position: 4 },
    { matchweek: 5, points: 79, position: 4 },
    { matchweek: 6, points: 95, position: 3 },
  ]
  ...
  return {
    ...
    player1: {
      player: {
        ...
        name: player1Name,
        pictureUrl: 'https://storage.googleapis.com/portopadelleague-storage/images/Player/pedropacheco.png',
        rankingPoints: 2522,
        points: 108,
        wins: 9,
        draws: 2,
      ...
      avgPointsPerMatchweek: 18,
      snapshots: player1Snapshots,
    },
    player2: {
      player: {
        id: payload.player2Id,
        name: player2Name,
        pictureUrl: 'https://storage.googleapis.com/portopadelleague-storage/images/Player/cuca_22.png',
        rankingPoints: 1988,
        points: 95,
        wins: 8,
        draws: 1,
      ...
      avgPointsPerMatchweek: 15.8,
      snapshots: player2Snapshots,
    },
    headToHead: [
      {
        matchId: 9001,
        ...
        divisionLabel: null,
        p1PartnerId: 'p8',
        p1PartnerName: 'Andrés Moreno',
        p2PartnerId: 'p15',
        p2PartnerName: 'Marcos Gil',
        p1Score: 8,
        p2Score: 6,
        winner: 'p1',
      },
      {
        ...
        matchweek: 4,
        division: 51,
        divisionLabel: 'Outono 2025 - 1ª Divisão',
        p1PartnerId: '28',
        p1PartnerName: 'Bernardo C',
        p2PartnerId: '33',
        p2PartnerName: 'Fred',
        p1Score: 6,
        p2Score: 8,
      ...
      },
      {
        ...
        matchweek: 6,
        division: 52,
        divisionLabel: 'Outono 2025 - 2ª Divisão',
        p1PartnerId: '32',
        p1PartnerName: 'Dinis',
        p2PartnerId: '22',
        p2PartnerName: 'Carlo',
